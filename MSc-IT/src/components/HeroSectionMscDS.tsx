      ...
      <div className="container mx-auto relative z-10 pb-48">
        ...
        >
          ...
          <p className="text-lg text-gray-700 mb-10 max-w-3xl mx-auto">
            Designed for aspiring data scientists, this two-year program integrates mathematics,
            statistics, and machine-learning with hands-on training in AI, big data, and analytics. With industry-driven courses and real-world case studies, graduates gain the expertise to thrive in finance, healthcare, e-commerce, and beyond.
          </p>
