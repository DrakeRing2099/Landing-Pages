        ...
        <section className="relative bg-white py-12 overflow-hidden">
            ...
            ADMISSION OPEN FROM 29TH MAY
                    ...
                    <div className="bg-white p-6 rounded-lg  text-center mt-20">
                        <h2 className="text-2xl font-semibold mb-4">Specializations offered under <span className="text-red-500">MTech ICT</span></h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="border p-4 rounded-lg hover:shadow-lg shadow-md">
                                Machine Learning (ML)
                            </div>
                            <div className="border p-4 rounded-lg hover:shadow-lg shadow-md">
